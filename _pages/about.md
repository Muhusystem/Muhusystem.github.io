...
Here is my [CV](http://Muhusystem.github.io/files/CV_JifengSong.pdf). My current work is enabling <b>efficient inference</b> by achieving sparse activation in LLMs and <b>Small Language Models (SLMs)</b> like Phi-2, Mobillama-0.5B, and Gemma-2B models. To achieve effective and effcient structured activation sparsity, we proposed a noval attribution metric named Corrected GxO for neuron selection based on <b>eXplainable AI (XAI)</b>. The Corrected GxO is more effective than traditional attribution metric including Gradient multiple Output Magnitude (GxO), Integrated Gradients (IG), SNIP, and Fisher information. Furthermore, we present a theoretical framework supporting the efficiency of the corrected GxO.

        ...
        <table class="pub-table">
          <tr>
            ...
            <td class="content-col">
              ...
              <div class="text-links">
                <a href="https://doi.org/10.1002/we.2909" class="text-btn">Paper</a>
              </div>
            </td>
          </tr>
        </table>
        ...
        <table class="pub-table">
          <tr>
            ...
            <td class="content-col">
              ...
              <div class="text-links">
                <a href="https://ieeexplore.ieee.org/document/9949665" class="text-btn">Paper</a>
              </div>
            </td>
          </tr>
        </table>
        ...
        <table class="pub-table">
          <tr>
            ...
            <td class="content-col">
              ...
              <div class="pub-venue">2022 IEEE/IAS Industrial and Commercial Power System Asia (I&CPS Asia)</div>
              <div class="text-links">
                <a href="https://ieeexplore.ieee.org/abstract/document/9949917" class="text-btn">Paper</a>
              </div>
            </td>
          </tr>
        </table>
